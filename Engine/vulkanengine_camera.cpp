...
{
    void VulkanEngineCamera::SetOrthographicProjection(float left, float right, float top, float bottom, float near, float far)
    {
    ...
    void VulkanEngineCamera::SetPerspectiveProjection(float fovy, float aspect, float near, float far)
    {
    ...
    void VulkanEngineCamera::SetViewTarget(glm::vec3 position, glm::vec3 world_space_target, glm::vec3 up)
    {
        SetViewDirection(position, world_space_target - position, up);
    }

    void VulkanEngineCamera::SetViewYXZ(glm::vec3 position, glm::vec3 rotation)
    {
